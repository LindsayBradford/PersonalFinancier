...
/**
 * Implements an insertion Sort from greatest to smallest (only if all entries
 * are inserted with {@link #insertSorted(Object)}.. Essentially a tweak of an
 * insertion sort algorithm posted to stackexchange by user
 * http://stackoverflow.com/users/276052/aioobe Author: Mostly ailbo.
 * 
 * @param <T>
 */
