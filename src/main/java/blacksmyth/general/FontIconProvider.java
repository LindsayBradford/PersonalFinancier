...
public final class FontIconProvider {
  private static final String FONT_FILENAME = "fontawesome-webfont-4_7_0.ttf";

  private final Font baseIconFont;
  private final Font providedIconFont;
  ...
  protected FontIconProvider() {
    baseIconFont = ResourceBridge.getFont(FONT_FILENAME);
    registerFont(baseIconFont);
    providedIconFont = baseIconFont.deriveFont(Font.PLAIN, 24);
  }
